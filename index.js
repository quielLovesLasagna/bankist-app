...
// Functions
const defaultMessage = labelWelcome.textContent;

const formattedMovementDate = function (date, locale) {
  const calcDaysPassed = (date1, date2) =>
    Math.round(Math.abs(+date2 - +date1) / (1000 * 60 * 60 * 24));

  // Calculating days passed based on the current date and a given date
...
const startLogOutTimer = function () {
  ...
  const tick = function () {
    ...
    if (time === 0) {
      ...
      labelWelcome.textContent = defaultMessage;
    }
